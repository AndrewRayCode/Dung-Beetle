...
var dung_beetle = {
	start: function() {
		...
		document.bind('mousemove', this.mouseCapture);

		this.elements.overlay = this.jq.('<div></div>').attr('class', 'dung-overlay').appendTo('body');
	...
	mouseCapture: function(evt) {
		...
		if(this.settings.color_hover) {
			dung_color_hover.css({'left':(this.input.mouse.x+9)+'px', 'top':(this.input.mouse.y+9)+'px'});
		}
	},
	noex: function() {
